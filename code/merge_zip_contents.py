...
def setup_logger(config: Dict[str, Any], debug_mode: bool) -> logging.Logger:
    """
    Set up the logger with the given configuration and debug mode.

    Args:
        config (Dict[str, Any]): The configuration for the logger.
...
def organize_data(data_list, source_name, logger):
    ...
    for data_item in data_list:
        ...
        #
        #
        if data_type in ['html', 'txt', 'text', 'markdown', 'pdf', 'image', 'other']:
